    ...
    class $mol_view extends $mol_object {
        ...
        dom_node(next) {
            ...
            for (let event_name in events) {
                node.addEventListener(event_name, this.event()[event_name], { passive: false });
            }
            return node;
        }
        dom_final() {
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "A", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "B", null);
    $.$my_debug = $my_debug;
    class $my_debug_a extends $mol_view {
        style() {
            return {
                width: 100,
                height: 50,
    ...
    __decorate([
        $mol_mem
    ], $my_debug_a.prototype, "click", null);
    $.$my_debug_a = $my_debug_a;
    class $my_debug_b extends $my_debug_a {
    }
    $.$my_debug_b = $my_debug_b;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $my_debug_a extends $.$my_debug_a {
            click() {
                console.log(123);
            }
        }
