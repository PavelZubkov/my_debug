...
(function ($) {
    class $mol_wire_atom extends $mol_wire_fiber {
        static solo(host, task) {
            ...
            console.log('created', fiber.toString());
            return fiber;
        }
        ...
        destructor() {
            console.log('drop', this.toString());
            super.destructor();
            const prev = this.cache;
...
var $;
(function ($) {
    class $my_debug_model extends $mol_object2 {
        state() {
    ...
    __decorate([
        $mol_mem
    ], $my_debug_model.prototype, "state", null);
    __decorate([
        $mol_mem
    ], $my_debug_model.prototype, "doc", null);
    __decorate([
        $mol_action
    ], $my_debug_model.prototype, "counter_inc", null);
    $.$my_debug_model = $my_debug_model;
})($ || ($ = {}));
//my/debug/model/model.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $my_debug extends $mol_page {
        ...
        Counter_control() {
            ...
            obj.value = (next) => this.counter(next);
            return obj;
        }
        Counter_block() {
            const obj = new this.$.$mol_labeler();
    ...
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "model", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Source", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Name_value", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Name_control", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Name_block", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Counter_value", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Counter_control", null);
    __decorate([
        $mol_mem
    ], $my_debug.prototype, "Counter_block", null);
    $.$my_debug = $my_debug;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $my_debug_server extends $mol_object2 {
        static bootstrap() {
            console.log(1);
            if ($mol_state_arg.value('--my_debug_server') === null)
                process.exit(0);
            console.log(2);
            const obj = new this;
            obj.run();
    ...
    __decorate([
        $mol_mem
    ], $my_debug_server.prototype, "model", null);
    __decorate([
        $mol_mem
    ], $my_debug_server.prototype, "run", null);
    __decorate([
        $mol_mem
    ], $my_debug_server, "bootstrap", null);
    $.$my_debug_server = $my_debug_server;
    setTimeout(() => {
        console.log(0);
        $mol_dom_context._origin = 'http://127.0.0.1:9080';
        $my_debug_server.bootstrap();
    });
})($ || ($ = {}));
//my/debug/server/server.node.ts
;
export default $
